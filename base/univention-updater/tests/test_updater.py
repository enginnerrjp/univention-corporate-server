...
class TestUniventionUpdater(unittest.TestCase):
    ...
    def test_get_current_component_status_DISABLED(self):
        ...
        ORIG = U.FN_APTSOURCES_COMPONENT
        try:
            tmp = NamedTemporaryFile()
            U.FN_APTSOURCES_COMPONENT = tmp.name
            self.assertEqual(U.Component.DISABLED, self.u.component('a').status())
        finally:
            U.FN_APTSOURCES_COMPONENT = ORIG
            tmp.close()
    ...
    def test_get_component_defaultpackage(self):
        ...
        self.assertEqual(set(('b',)), self.u.component('b').default_packages)
        self.assertEqual(set(('ca', 'cb')), self.u.component('c').default_packages)
        self.assertEqual(set(('da', 'db')), self.u.component('d').default_packages)
    ...
    def test__get_component_version_short(self):
        ...
        ver = self.u.component('a').versions(None, None)
    ...
    def test__get_component_version_current(self):
        ...
        comp_ver = self.u.component('a').versions(start=ver, end=ver)
    ...
    def test_get_component_repositories_ARCH(self):
        ...
        r = self.u.component('a').repositories((U.UCS_Version((MAJOR, MINOR, 0)),))
        self.assertEqual(set((
